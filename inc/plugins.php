...
function tabor_register_required_plugins() {
	...
	$args = array(
		array(
			'name'     => esc_html__( 'Portfolio Post Type', '@@pkg.textdomain' ),
			'slug'     => 'portfolio-post-type',
			'required' => true,
		),

		array(
			'name'     => esc_html__( 'Multiple Post Thumbnails', '@@pkg.textdomain' ),
			'slug'     => 'multiple-post-thumbnails',
			'required' => false,
		),

		array(
			'name'     => esc_html__( 'Contact Form 7', '@@pkg.textdomain' ),
			'slug'     => 'contact-form-7',
			'required' => false,
		),
	);
