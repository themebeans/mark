 ...
 */
function mark_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function mark_sanitize_css( $css ) {
 ...
 */
function mark_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function mark_sanitize_email( $email, $setting ) {
 ...
 */
function mark_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function mark_sanitize_html( $html ) {
 ...
 */
function mark_sanitize_image( $image, $setting ) {
 ...
 */
function mark_sanitize_nohtml( $nohtml ) {
 ...
 */
function mark_sanitize_number_absint( $number, $setting ) {
...
function mark_sanitize_number_intval( $int ) {
	return intval( $int );
}
 ...
 *                    the setting default.
 */
function mark_sanitize_number_range( $number, $setting ) {
 ...
 */
function mark_sanitize_select( $input, $setting ) {
 ...
 */
function mark_sanitize_url( $url ) {
