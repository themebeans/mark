...
class Bean_Flickr_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'bean_flickr', // Base ID
			esc_html__( 'Flickr Photos', 'mark' ), // Name
			array(
				'description'                 => esc_html__( 'Add a Flickr feed widget.', 'mark' ),
...
<p><?php echo balanceTags( $desc ); ?></p><?php endif; ?>
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title / Intro:', 'mark' ); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'flickrID' ) ); ?>"><?php esc_html_e( 'Flickr ID:', 'mark' ); ?> (<a target="_blank" href="http://idgettr.com/">idGettr</a>)</label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php esc_html_e( 'Type:', 'mark' ); ?></label>
...
>Group</option>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'display' ) ); ?>"><?php esc_html_e( 'Display:', 'mark' ); ?></label>
